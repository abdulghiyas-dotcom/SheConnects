        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {filteredFreelancers.map((f) => (
            <div key={f.slug} className="rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
              ...
              <Link href={`/freelancers/${f.slug}`} className="mt-8 inline-block rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 px-6 py-2.5 text-sm font-medium text-white transition">
