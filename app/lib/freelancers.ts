...
export const freelancers: Freelancer[] = [
  {
    ...
    it: {
      ...
      bio: "Professionista creativa con oltre 4 anni di esperienza nello storytelling visivo e nei servizi linguistici. Gita è specializzata nel superare le barriere culturali attraverso illustrazioni di alta qualità e traduzioni accurate di documenti.",
      services: [
